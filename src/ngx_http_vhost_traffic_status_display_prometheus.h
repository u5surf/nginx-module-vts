...
#define NGX_HTTP_VHOST_TRAFFIC_STATUS_PROMETHEUS_FMT_SERVER                    \
    ...
    "nginx_vts_server_requests_total{host=\"%V\",version=\"09\"} %uA\n"        \
    "nginx_vts_server_requests_total{host=\"%V\",version=\"10\"} %uA\n"        \
    "nginx_vts_server_requests_total{host=\"%V\",version=\"11\"} %uA\n"        \
    "nginx_vts_server_requests_total{host=\"%V\",version=\"20\"} %uA\n"        \
